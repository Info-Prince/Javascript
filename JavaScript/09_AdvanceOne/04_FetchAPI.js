...
// fetch() won't create queue but spec ial queue (named priority queue, micro task queue) created for fetch.  These queue perform action Faster than other queue.
