...
//      Doesn't block execution -> read file async

// both depends on usecase , when we would have require to block code execution and read file as if user registration we will use sync, and the time we need non blocking code we use async.
